...
![](random_fields_1d_files/figure-html/unnamed-chunk-4-1.png)
...
[`summary( )`](https://rdrr.io/r/base/summary.html) as below if you want
to, but you do not need to understand this output, or the code that
makes the predictions immediately below it if you are not familiar with
GAMs.
...
![](random_fields_1d_files/figure-html/unnamed-chunk-10-1.png)
...
![](random_fields_1d_files/figure-html/unnamed-chunk-13-1.png)
...
![](random_fields_1d_files/figure-html/unnamed-chunk-14-1.png)
...
![](random_fields_1d_files/figure-html/unnamed-chunk-18-1.png)
...
[`plot( )`](https://rdrr.io/r/graphics/plot.default.html), as below.

``` r
plot(fit2.bru, "Intercept")
```

![](random_fields_1d_files/figure-html/unnamed-chunk-20-1.png)
...
![](random_fields_1d_files/figure-html/unnamed-chunk-23-1.png)
...
![](random_fields_1d_files/figure-html/unnamed-chunk-24-1.png)
